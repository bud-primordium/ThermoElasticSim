...
class TestAtomConstructor:
    ...
    def test_constructor_with_velocity(self):
        ...
        atom = Atom(
            id=1, symbol="O", mass_amu=15.999, position=[1, 2, 3], velocity=velocity
        )
...
class TestAtomCopy:
    ...
    def test_copy_array_independence(self):
        ...
        atom1 = Atom(
            id=1, symbol="H", mass_amu=1.0, position=position1, velocity=velocity1
        )
        atom2 = atom1.copy()
...
class TestAtomEdgeCases:
    ...
    def test_large_values(self):
        ...
        atom = Atom(
            id=999, symbol="Au", mass_amu=196.97, position=large_pos, velocity=large_vel
        )
    ...
    def test_nan_inf_handling(self):
        ...
        atom = Atom(id=1, symbol="H", mass_amu=1.0, position=[np.nan, 0, 0])

        assert np.isnan(atom.position[0])

        # 无穷大值
        atom2 = Atom(id=2, symbol="O", mass_amu=16.0, position=[np.inf, -np.inf, 0])
