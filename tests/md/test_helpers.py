...
def simple_energy_minimization(
    cell, potential, max_iterations=100, force_tolerance=1e-3
):
    """简单的能量最小化优化
...
def create_equilibrated_fcc_aluminum(
    supercell_size=(2, 2, 2), temperature=300.0, with_optimization=True
):
    """创建已平衡的FCC铝测试系统
